...
- (void)updateZoomRegionHorizontal
{
    ...
    self.layer.frame = CGRectMake(self.zoomRegionHorizontal, self.zoomRegionVertical, self.bounds.size.width + (self.zoom * 375), self.bounds.size.height + (self.zoom * 375));
    ...
    self.previewLayer.frame = CGRectMake(self.zoomRegionHorizontal, self.zoomRegionVertical, self.bounds.size.width + (self.zoom * 375), self.bounds.size.width + (self.zoom * 375));
...
- (void)updateZoom {
    ...
    device.videoZoomFactor = (device.activeFormat.videoMaxZoomFactor - 2.0) * self.zoom + 1.0;
...
//     return [self.videoCaptureDeviceInput device];
// }
