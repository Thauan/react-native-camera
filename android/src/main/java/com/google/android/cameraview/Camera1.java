...
//    }
    ...
    @Override
    void setExposureCompensation(float exposureCompenstion) {
        if (exposureCompenstion == mExposureCompensation) {
            return;
        }
        if (setExposureCompensationInternal(exposureCompenstion)) {
            Log.e("MyComponent", "td certo com exposure");
            mCamera.setParameters(mCameraParameters);
        }
    }
    ...
    private boolean setExposureCompensationInternal(float exposureCompensation) {
